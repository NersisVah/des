...
class StoryBrain {
  List<Story> _storyData = [
    ...
    Story(
      storyTitle:
        ' 1 He nods slowly, unphased by the question.',
...
int _storyNumber = 0;
//+TODO: Step 17 - Create a method called nextStory(), it should not have any outputs but it should have 1 input
...
bool buttonShouldBeVisible(){
  if(_storyNumber == 1 || _storyNumber == 2 || _storyNumber == 0){return true;}
  else {return false;}
